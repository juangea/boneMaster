...
bool BlenderViewportParameters::get_viewport_display_denoising(BL::SpaceView3D &b_v3d)
{
  ...
  if (b_v3d) {
    ...
    use_denoising = get_boolean(cshading, "use_optix_denoising");
  }
...
bool update_viewport_display_denoising(BL::SpaceView3D &b_v3d)
{
  return BlenderViewportParameters::get_viewport_display_denoising(b_v3d);
}
