...
static void rna_def_cloth_sim_settings(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(
      ...
      "How much cloth should retain in plane deformations after reaching yield point");
  RNA_def_property_update(prop, 0, "rna_cloth_update");
  ...
  RNA_def_property_ui_text(prop,
                           "Structural Yield Factor",
                           "How much cloth has to deform in plane before plasticity takes effect");
  RNA_def_property_update(prop, 0, "rna_cloth_update");
  ...
  RNA_def_property_ui_text(
      prop,
      "Bending Plasticity",
      "How much cloth should retain bending deformations after reaching yield point");
  RNA_def_property_update(prop, 0, "rna_cloth_update");
  ...
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_ui_text(
      prop, "Bending Yield Factor", "How much cloth has to bend before plasticity takes effect");
  RNA_def_property_update(prop, 0, "rna_cloth_update");
